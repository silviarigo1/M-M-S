...
class Places{
 ...
 static Map<String, List<dynamic>> mapDest = {"title": ["Cappella degli Scrovegni", 
    ...
    "I Giardini dell'Arena di Padova fondono un ricco passato storico, racchiusi tra i resti dell'anfiteatro romano, le storiche mura trecentesche e la celebre Cappella degli Scrovegni di Giotto. Inoltre, offre la possbilità di fare una piacevole sosta con un aperitivo o un caffè in uno dei chioschi del parco.",
    ...
    "Pasticceria storica di Padova, fondata nel 1967. Famosa per i suoi dolci tradizionali, tra cui la Torta Pazientina. Il luogo ideale per una sosta veloce e piacevole, non lontana dal centro città, perfetta per ricaricare le energie dopo una giornata di visite.",
    ...
    "La trattoria più antica di Padova. Atmosfera accogliente e famigliare che ricrea l'atmosfera originale del XIX secolo. Sapori genuini della tradizione veneta, legata alle stagioni e con prodotti sempre freschi a km 0. Situata in una zona tranquilla e lontana dalle rotte turistiche più battute."
    ],
    "hours": _hours,
    "steps": _steps,
    "crowded": _crowded,
